...
# columns: time m0 m1 m2 m3 pitch pitch_desired roll roll_desired thrust yaw_rate yaw_desired
...
if not data:
    print("No data found. Make sure the file has 12 columns per line.")
    sys.exit(1)
