...
ax1.plot(t, roll_gyro,  label='measured pitch * 10',      linewidth=1, linestyle=':')
ax1.plot(t, pitch_filt,  label='pitch velo', linewidth=1)
ax1.plot(t, pitch_accel,  label='thrust', linewidth=1)
