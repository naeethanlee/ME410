...
void read_imu()
{
  ...
  imu_data[3]=((float)vw - x_gyro_calibration)*1000.0/32768.0;//convert to degrees/sec
  ...
  imu_data[4]=((float)vw - y_gyro_calibration)*1000.0/32768.0;//convert to degrees/sec
  ...
  imu_data[5]=((float)vw - z_gyro_calibration)*1000.0/32768.0;//convert to degrees/sec  
